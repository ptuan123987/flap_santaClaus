    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == spawn_tube:
                tube_list.extend(tube.create_tube())
        ...
        if active:
            ...
            game_score.score_screen('main game')
            if countdown :
                countdown = False
        ...
        floor.draw_floor()  # vẽ ống lên màn hình
